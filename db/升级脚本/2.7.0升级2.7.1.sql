...
insert into `base_upms`.`sys_menu` (`id`, `name`, `permission`, `path`, `parent_id`, `icon`, `component`, `sort`, `keep_alive`, `type`, `create_time`, `update_time`, `del_flag`) values('2700000','文档管理',NULL,'https://demo.aiforest.com/doc.html','1227202152985784322','el-icon-s-claim','https://demo.aiforest.com/doc.html','8','0','0','2019-07-31 11:41:39','2019-07-31 11:57:07','0');
