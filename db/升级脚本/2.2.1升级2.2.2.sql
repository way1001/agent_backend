...
UPDATE `base_mall`.`order_info` SET `app_type` = '1' WHERE `app_type` = '';
UPDATE `base_mall`.`order_info` SET `payment_way` = '2' WHERE `payment_way` = '';
UPDATE `base_mall`.`order_info` SET `is_pay` = '1' WHERE `status` IN('1','2','3','4');
UPDATE `base_mall`.`order_info` SET `is_pay` = '0' WHERE `status` IN('0','5');
UPDATE `base_mall`.`order_info` SET `appraises_status` = '0' WHERE `status` IN('3');
UPDATE `base_mall`.`order_info` SET `appraises_status` = '1' WHERE `status` IN('4');
UPDATE `base_mall`.`order_info` SET `status` = '3' WHERE `status` IN('4');

UPDATE `base_mall`.`goods_sku` SET `enable` = '1' WHERE `enable` = 'true';
UPDATE `base_mall`.`goods_sku` SET `enable` = '0' WHERE `enable` = 'false';
