...
@Component
@AllArgsConstructor
public class ManagerAssignsStartListener implements TaskListener {
...
//	private final Logger LOGGER = Logger.getLogger(ManagerAssignsStartListener.class.getName());

//	@Override
//	public void notify(DelegateExecution delegateExecution) throws Exception {
//
//		// get tenantId get affId to set assignee
//
...
//	}
	...
	public void notify(DelegateTask delegateTask) {
		...
		VariableDefinition userRolesDefinition = variableDefinitionService.getOne(Wrappers.<VariableDefinition>lambdaQuery()
				...
				.eq(VariableDefinition::getVariableId, "assignedRoles"));
