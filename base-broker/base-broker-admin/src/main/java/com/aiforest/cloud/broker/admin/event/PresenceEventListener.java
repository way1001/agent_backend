package com.aiforest.cloud.broker.admin.event;
...
public class PresenceEventListener {
	...
	public void handleSessionConnected(SessionConnectEvent event) {
		...
		participantRepository.getActiveSessions().forEach( (k, v) -> {
			if (loginEvent.getUsername().equals(v.getUsername())) {
				participantRepository.removeParticipant(k);
			}
		});
