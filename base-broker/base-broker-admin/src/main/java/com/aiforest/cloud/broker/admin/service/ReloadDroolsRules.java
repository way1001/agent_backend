...
import com.aiforest.cloud.broker.admin.config.KieUtils;
...
public class ReloadDroolsRules {
    ...
    private String loadRules() {
        // 从数据库加载的规则
        return "package aiforest.process\n\n import com.aiforest.cloud.broker.common.entity.SubprocessDefinition;\n;\n import com.aiforest.cloud.broker.common.fact.ProcessRuleCheckResult;\n\n rule \"Postcode 6 numbers\"\n\n    when\n  then\n        System.out.println(\"规则2中打印日志：校验通过!\");\n end";
